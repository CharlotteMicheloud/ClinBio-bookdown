...
Notice that $\boldsymbol{W}^{-1}$ is often called **working covariance matrix** to distinguish it from the **true covariance matrix** $\boldsymbol{\Sigma}$. It is an approximation to the true covariance matrix of the outcomes.
