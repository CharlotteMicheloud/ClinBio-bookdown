...
:::{.example}
Table \@ref(tab:kidney) summarizes the results from an observational study from
@charig about two different treatments of kidney stones. This is a 
non-randomized study, as can be seen from the different distribution 
of the two therapies among patients with small resp. large kidney stones 
($87:270$ vs. $263:80$). 
:::
