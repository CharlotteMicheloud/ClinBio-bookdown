...
if wither $b=0$ or $c=0$. Likewise, the standard error \@ref(eq:orse)
...
potential bias of the original estimate, so for example
@spiegelhalter2004, Secrion 2.4.1. Another estimate of the odds ratio
...
same problem of the standard (unconditional) MLE \@ref(eq:or) that it
