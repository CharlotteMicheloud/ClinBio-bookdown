...
*Reliability* of a measurement is characterized by the correlation coefficient between pairs of readings. 
...
<!-- ::: -->
:::{.example #Hazir}
In a study of chest radiography in children in Pakistan (see @Hazir2006), children aged 2 to 59 months with non-severe pneumonia were invited to participate. In total 2000 children were enrolled, for whom 1848 chest radiographs were available for assessment. Two consultant radiologists used standardized criteria to evaluate the chest radiographs, with no clinical information available to them. The primary outcome was diagnosis of pneumonia (absent or
...
that there is perfect agreement ($\pobs=1$), $\kappa = 0$ means that the agreement not larger than expected by chance ($\pobs=\pexp$), and the smallest possible value of $\kappa$ is $-\pexp/(1-\pexp)$. A negative $\kappa$ means that the agreement is worse than by chance. 
...
This case shows that $\kappa$ can be small even you have good agreement.
