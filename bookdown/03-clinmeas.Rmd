...
Under normality, $\bar{d}$ and $s_d$ are independent. Using this and the fact 
that 
$\Var(\bar{d})=\sigma_d^2/n$, with $\sigma^2_d$ the population
variance of the differences, and $\Var(s_d) \approx \sigma_d^2/2n$, 
