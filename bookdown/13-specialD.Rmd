...
The latter is the preferred analysis on practice level, 
as it takes into account the different sample sizes in the different practices. 
...
For example, suppose $\bar n_c=7$ and $\rho=0.5$, then $\Deff=4$, 
...
wonder if there based their calculation on a 90% CI instead of a 95% CI.
:::
