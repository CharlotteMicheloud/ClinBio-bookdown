...
```{r echo=FALSE}
print(tTest1$statistic)
## exact p-value based on t-distribution
unname(2*(1-pt(abs(tTest1$statistic), df=23)))
## normal approximation
unname(2*(1-pnorm(abs(tTest1$statistic))))
```
...
Welch's test can be used in the case of unequal variances:
...
# print(DifferenceInMeans <- mean(WelchTest1$conf.int))
...
In the Didgeridoo example, both Welch's and Behren's test 
