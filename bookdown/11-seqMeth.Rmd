...
<!--Steffi, 20.11.2024: I wanted to use the above reference to Section 5.2 (as it shows in the html) to add a reference to SPIRIT in Chapter 6.3.1. But then I saw that the above reference is actually to Table 5.2 (tab:samplesizecont), not Section 5.2. Which is correct?
