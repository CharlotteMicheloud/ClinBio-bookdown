...
the treatment, the worryingly high incidence of side effects, 
or the evidence that the new treatment is less efficacious than the
existing treatment.
...
Suppose that we have two equally sized treatment arms and a continuous outcome. 
The primary outcome is the difference in means $\theta$.
...
detectable difference (MDD, Compare Section \@ref(tab:samplesizecont)) for the treatment effect estimate:
