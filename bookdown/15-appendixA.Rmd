...
In`R`,Wald CIs for OR and RR and a Wilson CI for ARR can be computed using the function `twoby2()` from the library `Epi`.
...
is then very close to zero. Note that \@ref(eq:eq3App)  differents that in 
