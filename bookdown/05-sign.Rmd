...
$\tilde p =  1 - p/2 = `r biostatUZH::formatPval(res.baby3$p.val, break.eps = 1e-5)`$.
...
the confidence interval needs to be of Wald-type and the $P$- 
...
\[
n = \frac{\pi_1 (1-\pi_1) + \pi_0 (1-\pi_0)}{\SE(\hat \Delta)^2}=  16 \, \frac{\pi_1 (1-\pi_1) + \pi_0 (1-\pi_0)}{w^2} \, .
\]
