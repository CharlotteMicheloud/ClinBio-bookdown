...
The difference is illustrated in Table \@ref(tab:signfigures). 
...
The one-way ANOVA for the PEFR is computed:
...
I AM HERE, FIND ANOTHER EXAMPLE
dataset bloddpressure in package mecor
