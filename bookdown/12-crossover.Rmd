...
### Test for carryover {#testcarryover}
...
The negative sign of the carryover effect is a consequence of a systematic difference in the outcome means between the AB and the BA group. For a perfectly randomized trial we would expect the sum of the two outcomes across the two treatment to be the same, but in the enuresis trial they are
...
We may also use a generalized linear mixed model (but results may depend on the choice of the integration parameter `nAGQ`):
