...
@arroll investigated the diagnostic accuracy of two verbally asked questions for screening for depression in 15 general practices in New Zealand. Figure \@ref(fig:depression) gives the numbers of true 
positives, false positives, true negatives, false 
negatives, sensitivity and specificity, positive and negative likelihood ratio (with 95\% CI) of each question and both questions combined.
:::
...
```{r echo=TRUE}
level <- c(0.9, 0.95, 0.99) # confidence levels
