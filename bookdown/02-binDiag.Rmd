...
individuals without the disease ($D=0$) (equation \@ref(eq:DOR1). It can also be written as the ratio of the odds of diseasae in test positives relative to the odds of disease in test negatives (equation \@ref(eq:DOR2)). 
