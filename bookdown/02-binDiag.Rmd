...
:::{.example}
Accuracy of emergency department clinical findings for diagnosis of 
coronavirus disease 2019 [@Peyrony2020], see Figure \@ref(fig:peyrony)
:::


```{r}
knitr::include_graphics("figures/Peyrony_Table2.png")
```
           
```{r peyrony, fig.cap = "Reporting of diagnostic accuracy measures with confidence intervals in @Peyrony2020", echo = FALSE}
knitr::include_graphics("figures/Peyrony_Table4.png")
```
