...
An alternative approach based on the *arcsine square root transformation* 
(also variance-stabilizing transformation) $h(\pi) = \arcsin(\sqrt{\pi})$ is described in @matthews (Sec. 3.4) where
