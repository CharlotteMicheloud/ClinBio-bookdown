...
```{r SPIRITchecklist_p1, fig.cap="The SPIRIT checklist (items 1--17).", fig.align="center", echo=FALSE, eval = TRUE}
knitr::include_graphics("figures/SpiritCheckList_part1.png")
```

```{r SPIRITchecklist_p2, fig.cap="The SPIRIT checklist (items 18--33).", fig.align="center", echo=FALSE, eval = TRUE}
