...
We set the following notation for a *meta-analysis* ovf $i=1,\ldots, n$ trials:
...
```{r trimfillSmoking, echo=FALSE, fig.cap="Trim-and-fill method in the passive smoking Example \\@ref(exm:tobacco).", fig.align='center'}
