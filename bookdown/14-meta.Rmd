...
```{r trimfillStroke, echo=FALSE, fig.cap="Trim-and-fill method in Example \\@ref(exm:stroke). The black circles represent the 11 observed studies whereas the red studies on the left are imputed, based on symmetrically 'mirroring' the trimmed studies on the right."}
...
```{r trimfillSmoking, echo=FALSE, fig.cap="Trim-and-fill method in the passive smoking Example \\@ref(exm:smoking).", fig.align='center'}
