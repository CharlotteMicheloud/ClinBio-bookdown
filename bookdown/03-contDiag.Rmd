...
A proof of this result can be found in Appendix \@ref(app:AUC). 
...
Consideration has to be given to the *cost ratio* of a false positive to a false negative diagnosis. Also the prevalence (\mbox{Pre}) of the disease in the population to be tested is important.
