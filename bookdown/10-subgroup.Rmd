...
with $T_i=\hat \theta_i/\SE(\hat \theta_i)$ being the test statistics in each
...
:::{.example #breast}
In the  National Surgical Adjuvant Breast and Bowel Project Trial [@Fisher1983] 
(Section 9.2), the outcome was disease-free survival at 3 years,
...
kable(df, booktabs = TRUE, escape = FALSE, 
      caption = "Subgroups by age and progesterone receptor status (PR) in the National Surgical Adjuvant Breast and Bowel Project Trial [@Fisher1983].", label = NA) %>%
